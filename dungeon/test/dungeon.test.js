...
describe('Fortran parity sessions (per-step, seed=42)', () => {
    ...
    it('containers session matches Fortran byte-for-byte', () => checkSession('containers'));
    it('magic session matches Fortran byte-for-byte', () => checkSession('magic'));
    it('combat session matches Fortran byte-for-byte', () => checkSession('combat'));
    it('collective session matches Fortran byte-for-byte', () => checkSession('collective'));
    it('underground session matches Fortran byte-for-byte', () => checkSession('underground'));
    it('burn session matches Fortran byte-for-byte', () => checkSession('burn'));
    it('scoring session matches Fortran byte-for-byte', () => checkSession('scoring'));
    it('items session matches Fortran byte-for-byte', () => checkSession('items'));
    it('verbs2 session matches Fortran byte-for-byte', () => checkSession('verbs2'));
    it('maze session matches Fortran byte-for-byte', () => checkSession('maze'));
    it('deep-cave session matches Fortran byte-for-byte', () => checkSession('deep-cave'));
    it('outdoor session matches Fortran byte-for-byte', () => checkSession('outdoor'));
