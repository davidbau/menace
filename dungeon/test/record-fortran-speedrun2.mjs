#!/usr/bin/env node
// Record the Fortran session for speedrun-2 with --More-- pagination handling.
// The Fortran NIRVA room requires 2 Enter keypresses for --More-- prompts.
...
const inputFile = join(__dirname, 'sessions/speedrun-2.input');
...
const env = { ...process.env, DUNGEON_SEED: '2' };
...
const outputPath = join(__dirname, 'sessions/speedrun-2.fortran.json');
