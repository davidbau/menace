...
BASIC spread fast. GE licensed it for its commercial timesharing systems. Other universities adapted it. By the early 1970s, [Digital Equipment Corporation](https://en.wikipedia.org/wiki/Digital_Equipment_Corporation) had created BASIC-PLUS for the PDP-11 running under [RSTS/E](https://en.wikipedia.org/wiki/RSTS/E), adding string handling, matrix operations, and file I/O to the original Dartmouth design. BASIC-PLUS was the language that thousands of students and engineers encountered on DEC minicomputers throughout the 1970s and into the 1980s.
