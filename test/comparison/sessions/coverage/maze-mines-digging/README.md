...
4. `t04_s701_w_digext1_gp` (captured)
- extends `t04_s701` with additional wand directions (`j`, `k`) in one parity
  session to increase branch coverage without new harness complexity
...
4. `t04_s701_w_digext1_gp.session.json`
