...
export const mon = [
  ...
  [ // level 5 — C ref: hack.vars mon[5]
    ...
    { mname: 'troll',           mlet: 'T', mhd: 7, mmove: 12, ac: 4, damn: 2, damd: 6 },
    { mname: 'ugod',            mlet: 'u', mhd: 6, mmove: 11, ac: 5, damn: 1, damd:10 },
    { mname: 'xerp',            mlet: 'x', mhd: 7, mmove:  6, ac: 3, damn: 2, damd: 4 },
  ],
  [ // level 6 — C ref: hack.vars mon[6]
    { mname: 'invisible stalker', mlet: 'I', mhd: 8, mmove: 12, ac: 3, damn: 4, damd: 4 },
    { mname: 'umber hulk',      mlet: 'U', mhd: 9, mmove:  6, ac: 2, damn: 2, damd:10 },
    { mname: 'vampire',         mlet: 'V', mhd: 8, mmove: 12, ac: 1, damn: 1, damd: 6 },
    { mname: 'wumpus',          mlet: 'w', mhd: 8, mmove:  3, ac: 2, damn: 3, damd: 6 },
    { mname: 'xorn',            mlet: 'X', mhd: 8, mmove:  9, ac: -2, damn: 4, damd: 6 },
    { mname: 'zelomp',          mlet: 'z', mhd: 9, mmove:  8, ac: 3, damn: 3, damd: 6 },
    { mname: 'chameleon',       mlet: ':', mhd: 6, mmove:  5, ac: 6, damn: 4, damd: 2 },
  ],
  [ // level 7 — hardest — C ref: hack.vars mon[7]
    { mname: 'dragon',          mlet: 'D', mhd:10, mmove:  9, ac: -1, damn: 3, damd: 8 },
    { mname: 'ettin',           mlet: 'e', mhd:10, mmove: 12, ac: 3, damn: 2, damd: 8 },
    { mname: 'lurker above',    mlet: '~', mhd:10, mmove:  3, ac: 3, damn: 0, damd: 0 },
    { mname: 'neo-otyugh',      mlet: 'n', mhd:11, mmove:  6, ac: 0, damn: 1, damd: 3 },
    { mname: 'trapper',         mlet: ',', mhd:12, mmove:  3, ac: 3, damn: 0, damd: 0 },
    { mname: 'purple worm',     mlet: 'P', mhd:15, mmove:  9, ac: 6, damn: 2, damd: 8 },
    { mname: 'demon',           mlet: '&', mhd:10, mmove:  9, ac: -4, damn: 1, damd: 4 },
  ],
];
