...
const HELP_DETAILS = {
    ...
    advent: 'advent  — launch Colossal Cave Adventure (1977)\n  The original text adventure by Crowther and Woods.',
    ...
    spacewar: 'spacewar  — launch Spacewar! (1962)\n  Two-player space combat.\n  Needle: A/D rotate, W thrust, S fire, Q hyperspace.\n  Wedge: J/L rotate, I thrust, K fire, U hyperspace.',
...
async function help(args, shell) {
    ...
    const cmds = [
        ...
        ['basic',    'BASIC'],
        ['logo',     'Logo'],
        ['spacewar', 'Spacewar! (1962)'],
        ['nethack',  'NetHack'],
        ['hack',     'Hack (1982)'],
        ['rogue',    'Rogue (1980)'],
        ['advent', 'Adventure (1977)'],
        ['dungeon',  'Dungeon'],
    ];
...
export function getShellBuiltins(shell) {
    ...
    async function builtinHelp(args, env, io) {
        ...
        const cmds = [
            ...
            ['hack','Hack (1982)'],['rogue','Rogue (1980)'],['advent','Adventure'],['dungeon','Dungeon'],
        ];
    ...
    function makeLaunchBuiltin(game) {
        return async (args, env, io) => {
            ...
            const inShell = { dungeon: 'dungeon', advent: 'adventure', zork: 'dungeon' };
