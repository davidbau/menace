...
| S12 | [#292](https://github.com/davidbau/menace/issues/292) | objnam.c remaining naming parity | `Ready` |
...
| S28 | [#309](https://github.com/davidbau/menace/issues/309) | zap.c floor interaction parity | `Ready` |
...
| S42 | [#323](https://github.com/davidbau/menace/issues/323) | mthrowu+mcastu ranged parity | `Ready` |
| S43 | [#324](https://github.com/davidbau/menace/issues/324) | muse.c item-use AI parity | `Ready` |
| S44 | [#325](https://github.com/davidbau/menace/issues/325) | dungeon.c graph/branch parity | `Ready` |
| S45 | [#326](https://github.com/davidbau/menace/issues/326) | mklev+mkroom generation parity | `Ready` |
| S46 | [#327](https://github.com/davidbau/menace/issues/327) | mkmaze+mkmap generation parity | `Ready` |
| S47 | [#328](https://github.com/davidbau/menace/issues/328) | display.c mapglyph/windowport parity | `Ready` |
| S48 | [#329](https://github.com/davidbau/menace/issues/329) | vision.c remaining helper parity | `Ready` |
