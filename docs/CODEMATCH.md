...
| `[a]` | teleport.c | teleport.js | Teleportation. 30/37 C functions present: goodpos/onscary/enexto/enexto_core/epathto/teleds/tele/dotele/rloc/rloc_to/rloc_pos_ok/mtele_trap/mlevel_tele_trap/level_tele/level_tele_impl/results_in_death/safe_teleds/tele_restrict/mon_tele/mnexto/rloc_to_flag etc. Missing ~7 internal helpers (control_mon_tele, goodpos_onscary variants) |
