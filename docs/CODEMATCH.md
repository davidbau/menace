...
| `[N/A]` | decl.c | decl.js | Global variable declarations. 2 C public functions (decl_globals_init, sa_victual) both N/A in JS — init handled by module load, globals spread across player.js/dungeon.js/gstate.js/cmd.js. xdir/ydir → cmd.js, c_obj_colors → const.js |
...
| `[N/A]` | monst.c | monst.js | Monster data tables. 1 C public function (monst_globals_init) implicit in monsters.js module load. mons[] data → monsters.js (auto-generated by gen_monsters.py). PM_* indices, S_* class constants, MAXMCLASSES all in monsters.js. c_sa_yes/c_sa_no seduction attack arrays not yet needed |
