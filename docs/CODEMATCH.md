...
| `[a]` | steal.c | steal.js | Monster stealing. somegold/findgold/stealgold, unresponsive, remove_worn_item, steal, stealarm/unstolenarm/thiefdead, maybe_absorb_item, mdrop_obj, mdrop_special_objs, relobj, mpickobj implemented. Remaining major gap: `stealamulet` quest-artifact path depth. |
