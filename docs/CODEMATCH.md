...
|--------|--------|---------|-------|
| `[a]` | allmain.c | allmain.js | Main game loop. 14 JS exports covering ~15 C functions: moveloop/moveloop_core/moveloop_preamble, newgame, welcome, stop_occupation, regen_pw, regen_hp, u_calc_moveamt, init_sound_disp_gamewindows. Chargen UI split into chargen.js; browser entry in nethack.js. moveloop_core async for animation timing. Missing: do_positionbar (N/A), debug_fields/dump_enums (debug-only) |
...
| `[a]` | artifact.c | artifact.js | Artifact system. 77 exports covering 71/74 C public functions (96%). Generated data table (artifacts.js) with artilist[], SPFX_*, ART_* constants. Existence tracking, pure predicates, combat (spec_applies/bane_applies/spec_abon/spec_dbon wired into uhitm/mhitm/mhitu), discovery, glow/Sting, touch/retouch (`untouchable`). Remaining stubs are mostly invoke/retouch-intrinsic depth paths |
...
| `[a]` | dbridge.c | dbridge.js | Drawbridge mechanics. All 13 C functions present: is_pool/is_lava/is_pool_or_lava/is_ice/is_moat/is_drawbridge_wall/is_db_wall/drawbridge_up/drawbridge_down/create_drawbridge/destroy_drawbridge/open_drawbridge/close_drawbridge plus entity helpers |
| `[a]` | decl.c | decl.js | Global declarations. `decl_globals_init` and `sa_victual` now exposed as explicit compatibility surfaces (no-op in JS architecture); runtime init still handled by module/game startup. |
...
| `[a]` | dig.c | dig.js | Digging mechanics. All 39 C functions present: dig/dig_check/holetime/dighole/dig_up_grave/zap_dig/do_dig_corridor/do_mining/b_trapped/blow_up_landmine/could_dig/dig_corridor/dig_tunnel/bury_objs/unearth_objs/bury_an_obj/pick_axe_check/use_pick_axe/use_pick_axe2/mkcavepos/mkcavearea etc. `zap_dig()` uses awaited `nh_delay_output()` in interactive mode |
| `[a]` | display.c | display.js | Display/rendering. 58 JS exports covering ~25 public C functions (49 of 74 C functions are static/internal). tmp_at/nh_delay_output, newsym, show_glyph, display_monster/warning/show_mon_or_warn, docrt, flush_screen, cls, map_glyphinfo, see_monsters/objects/traps/walls, under_ground/water, magic_map_background, feel_newsym, swallowed, unswallow, reglyph_darkroom, redraw_map, row_refresh etc. Remaining: wall_angle (282-line rendering), reset_glyphmap (353-line state), some tty-specific helpers |
...
| `[x]` | drawing.c | symbols.js | Symbol/glyph drawing tables and lookup functions. Auto-generated by `gen_symbols.py` into `symbols.js` (defsyms[], DEF_*, S_stone..S_expl_br, MAXPCHARS, glyph offset constants GLYPH_*_OFF, SYM_OFF_*). S_* monster class constants (S_ANT..S_MIMIC_DEF, MAXMCLASSES) canonical home is `monsters.js`. Lookup helpers `def_char_to_objclass`, `def_char_to_monclass`, and `def_char_is_furniture` implemented |
| `[a]` | dungeon.c | dungeon.js | Dungeon structure and level management. 135 JS exports covering ~97 C functions (many C statics not applicable). Level/branch management, depth/dunlev, In_* level predicates, Is_* branch tests, on_level, assign_level, u_on_newpos, makelevel pipeline, topologize, fill_room, and 100+ helpers |
| `[a]` | eat.c | eat.js | Eating mechanics. handleEat (doeat) implemented; ~50 functions TODO |
| `[a]` | end.c | end.js | Game over, death, scoring. All 13 C functions present: done/done1/done2/done_in_by/panic/terminate/killer_format/delayed_killer/find_delayed_killer/dealloc_killer etc. JS adds getKiller/setKillerFormat infrastructure |
...
| `[a]` | explode.c | explode.js | Explosion effects. All 8/8 C public functions present plus ugolemeffects: adtyp_to_expltype, explosionmask (stub), engulfer_explosion_msg (stub), explode (3x3 area with resistance checks and C-style `tmp_at` animation), scatter (stub), splatter_burning_oil, explode_oil, mon_explodes |
...
| `[N/A]` | glyphs.c | glyphs.js | Glyph ID cache and customization. 21 C public functions, but almost all are terminal .nethackrc glyph customization infrastructure (fill_glyphid_cache, apply_customizations, shuffle_customizations, etc.) — N/A for browser port. `glyph_to_cmap()` (the one gameplay-relevant function) is implemented in glyphs.js. Glyph offset constants (GLYPH_*_OFF) → symbols.js (auto-generated by gen_symbols.py) |
...
| `[~]` | iactions.c | iactions.js | Item actions context menu. 1 C public function (itemactions) — displays interactive per-item action menu with context-sensitive choices. JS port bypasses this via direct inventory commands. 4 static helpers autotranslated but broken (missing imports/constants). Feature not in scope for session parity |
...
| `[a]` | mcastu.c | mcastu.js | Monster spellcasting. All 12/12 C public functions present: castmu, buzzmu, choose_magic_spell, choose_clerical_spell, cast_wizard_spell, cast_cleric_spell, m_cure_self, touch_of_death, death_inflicted_by, cursetxt (stub), is_undirected_spell, spell_would_be_useless. Plus aggravation, curse_objects (stubs) |
...
| `[a]` | monst.c | monst.js | Monster data tables. `monst_globals_init` is now an explicit compatibility surface (no-op; table init is module-load driven). mons[] data → monsters.js (auto-generated by gen_monsters.py). |
...
| `[a]` | objects.c | objects.js | Object data tables. objects.js is auto-generated from objects.h; `objects_globals_init` is now an explicit compatibility surface (no-op; module load already initializes data). |
| `[a]` | objnam.c | objnam.js | Object naming/wishing. 88 exports covering 73/79 C public functions (92%). xname/doname/makeplural/makesingular/readobjnam plus helper symbol set. Missing: minimal_xname, rnd_otyp_by_namedesc, singplur_lookup, strprepend, wishymatch, xcalled |
| `[~]` | options.c | options.js | Game options. JS: `options.js` now owns both data and `handleSet` UI flow |
| `[a]` | pager.c | pager.js | Text pager and look/describe commands. 55 JS exports covering ~47 C functions: dohelp/dowhatdoes/dohistory/doprev_message/doterrain, do_look/do_screen_description/dowhatis/doquickwhatis, look_at_monster/lookat, waterbody_name, self_lookat, add_cmap_descr, mhidden_description, object_from_map etc. Remaining: checkfile (data.base lookup), some display-only helpers |
...
| `[a]` | polyself.c | polyself.js | Polymorphing. All 25 C functions present: polymon/rehumanize/polyself/newman/polyman/change_sex/polyatwill/dobreathe/dospit/dospinweb/dosummon/dogaze/dohide/domindblast/uunstick/skinback/break_armor/drop_weapon/polysense etc. |
| `[a]` | potion.c | potion.js | Potion effects. 45+ functions: handleQuaff (dodrink) → peffects dispatcher for all 25 C potion types. Intrinsic timeout system: itimeout/set_itimeout/incr_itimeout. Status effects: make_confused/stunned/blinded/sick/hallucinated/vomiting/deaf/glib/slimed/stoned. All 25 peffect_* handlers including water/enlightenment/oil. healup, speed_up, potionhit, potionbreathe, dodip/potion_dip, mixtype, mongrantswish, djinni_from_bottle, ghost_from_bottle, split_mon. Remaining gaps: toggle_blindness (stub), some peffect bodies are RNG-skeleton only |
| `[a]` | pray.c | pray.js | Prayer and sacrifice. All 15/15 C public functions present: critically_low_hp, stuck_in_wall, desecrate_altar, dosacrifice, can_pray, dopray, doturn, altarmask_at, a_gname/a_gname_at, u_gname, align_gname, halu_gname, align_gtitle, altar_wrath. Plus 19 additional helpers (in_trouble, worst_cursed_item, god_zaps_you, fry_by_god, water_prayer, godvoice, gods_angry/upset, consume_offering, bestow_artifact, sacrifice_value, eval_offering, offer_corpse, pray_revive, prayer_done etc.). ~10 static helpers (fix_curse_trouble, please, give_spell) TODO |
| `[a]` | priest.c | priest.js | Priest behavior, temple management, shrine. 21/23 C functions present: newepri/free_epri, temple_occupied, histemple_at/inhistemple/has_shrine, findpriest, p_coaligned, mon_aligntyp, priestname, pri_move, intemple, forget_temple_entry, priest_talk, mk_roamer, reset_hostility, in_your_sanctuary, ghod_hitsu, angry_priest, clearpriests, restpriest. Missing: priestini, move_special (in monmove.js) |
...
| `[a]` | region.c | region.js | Region system. 34 exports covering 34/39 C public functions (87%). create_region, add/remove region/mon, run_regions, in_out_region, m_in_out_region, update_player_regions, gas cloud effects, save/rest. Missing: reset_region_mids, create_msg_region, enter_force_field, create_force_field, is_hero_inside_gas_cloud |
...
| `[a]` | rumors.c | rumors.js | Rumor/oracle/CapitalMon system. 19 JS exports covering ~14 C functions: unpadline, init_rumors, others_check, rumor_check, get_rnd_line, get_rnd_text, save/restore_oracles, outoracle, doconsult, couldnt_open_file, init_CapMons, CapitalMon. Uses JS data-driven architecture |
...
| `[a]` | sounds.c | sounds.js | Monster sounds, ambient room sounds, chat. All 22 C functions present: dosounds/domonnoise/growl/yelp/whimper/beg/dotalk/dochat/pet_noise plus room-specific sound helpers (throne/beehive/morgue/zoo/temple). Sound library N/A |
| `[a]` | sp_lev.c | sp_lev.js | Special level interpreter. 227 JS exports covering ~143 C functions. Full Lua-equivalent level description language: selection ops, room/corridor/object/monster/trap/stair/altar/fountain placement, map parsing, level flags, region setup, door/wall manipulation, coordinate and area selection arithmetic |
...
| `[a]` | stairs.c | stairs.js | Stairway management. All 17 C functions present with same names: stairway_add/free_all/at/find/find_from/find_dir/find_type_dir/find_special_dir, u_on_sstairs/upstairs/dnstairs, On_stairs/ladder/stairs_up/stairs_dn, known_branch_stairs, stairs_description. Find functions async by design. stairs_description simplified (missing Elemental Planes/quest checks) |
| `[a]` | steal.c | steal.js | Monster stealing. somegold/findgold/stealgold, unresponsive, remove_worn_item, steal, stealarm/unstolenarm/thiefdead, maybe_absorb_item, mdrop_obj, mdrop_special_objs, relobj, mpickobj implemented. `stealamulet` now implemented for invocation/amulet theft, worn-item pre-removal, inventory transfer, and teleport; remaining depth is quest-artifact selection once `is_quest_artifact()` is fully wired. |
...
| `[a]` | teleport.c | teleport.js | Teleportation. 33/37 C functions present: goodpos/goodpos_onscary/enexto/enexto_core/teleds/tele/dotele/rloc/rloc_to/rloc_pos_ok/mtele_trap/mlevel_tele_trap/level_tele/safe_teleds/tele_restrict/control_mon_tele/tele_to_rnd_pet/rloc_to_flag etc. Remaining gaps are mostly deeper behavior in existing functions rather than missing surfaces. |
| `[a]` | timeout.c | timeout.js | Timer-based effects. 60 JS exports covering ~54 C functions: nh_timeout (full intrinsic decrement loop), run_timers, start/stop/peek/insert/remove_timer, obj_move/split/stop_timers, obj_has_timer, spot timers, done_timeout, egg/figurine/burn timers, fall_asleep. Dialogue stubs for stoned/vomiting/sleep/choke/sickness/levitation/slime/phaze. Remaining gaps: full countdown text, float_down, vision system calls |
| `[a]` | topten.c | topten.js | High score table. observable_depth implemented; I/O funcs N/A; encode/format funcs TODO |
| `[a]` | track.c | track.js | Player tracking for pets. All 6/6 C public functions: initrack, settrack, gettrack, hastrack, save_track, rest_track |
| `[a]` | trap.c | trap.js | Trap mechanics. 49/64 C public functions present (76%): dotrap, mintrap, mintrap_postmove, m_harmless_trap, floor_trigger, mon_check_in_air, trapeffect_selector_you/mon, erode_obj, water_damage, rust_dmg, grease_protect, acid_damage, t_at, seetrap, cnv_trap_obj, trap_to_part_name, chest_trap, dng_bottom, dountrap, set_utrap, reset_utrap, u_entries_recalc, steedintrap, unconscious, launch_in_progress, sokoban_guilt, drain_en, trapname, force_launch_placement, clamp_hole_destination, maketrap/deltrap/burnarmor (in dungeon.js/zap.js). Rolling-boulder path with tmp_at/nh_delay_output timing. Missing ~15: animate_statue, back_on_ground, climb_pit, drown, fall_through, immune_to_trap, launch_obj, lava_damage/effects, etc. |
...
| `[a]` | were.c | were.js | Lycanthropy. All 8 public C functions aligned: were_change/counter_were/were_beastie/new_were/were_summon/you_were/you_unwere/set_ulycn. |
...
| `[a]` | wizard.c | wizard.js | Wizard of Yendor AI. 18/21 C functions present: mon_has_arti, other_mon_has_arti, on_ground, target_on, choose_stairs, amulet, mon_has_amulet, mon_has_special, tactics, has_aggravatables, aggravate, clonewiz, pick_nasty, nasty, resurrect, intervene, wizdeadorgone, cuss. Missing ~3 internal helpers |
...
|---------|---------|----------------|
| animation_examples.js | Animation demo data (**blacklisted from CODEMATCH parity scope**) | None (JS-only) |
...
| delay.js | Delay/animation timing wrappers (**blacklisted from CODEMATCH parity scope**): `delay_output`, `delay_output_raf` | None (JS-only) |
...
| kick.js | Kick command adapter | dokick.c |
| dokick.js | C-structured kick/object migration callchain | dokick.c |
...
| 1749 | `doinvoke` | artifact.js:1230 | Implemented (getobj-backed invoke selection, retouch gate, then arti_invoke dispatch) |
...
| 1848 | `invoke_charge_obj` | artifact.js:1307 | Partial — C-shaped cancel semantics (`age=0`, `ECMD_CANCEL`) plus `charge_ok` target filter and role-aware blessed recharge effect; GETOBJ flag UX nuances remain |
...
| 1780 | `invoke_healing` | artifact.js:1254 | Partial — C-shaped half-heal path plus Sick/Slimed clear and timed-blindness reduction to cream-layer timeout; remaining messaging nuance (`slightly better`) and polymorph/permablind edge wording |
...
| 1838 | `invoke_untrap` | artifact.js:1298 | Partial — routes through `dountrap` and now mirrors C cancel semantics (`age=0`, `ECMD_CANCEL`) when no untrap action occurs |
...
| 2598 | `untouchable` | artifact.js:617 | Implemented |
...
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 1066 | `decl_globals_init` | decl.js:decl_globals_init | Implemented |
| 1185 | `sa_victual` | decl.js:sa_victual | Implemented |
...
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 947 | `better_not_try_to_drop_that` | do.js:174 | Implemented |
| 50 | `boulder_hits_pool` | do.js:318 | Implemented |
| 665 | `canletgo` | do.js:108 | Implemented |
| 2314 | `cmd_safety_prevention` | do.js:1703 | Implemented |
| 1348 | `currentlevel_rewrite` | do.js:1285 | Implemented |
...
| 800 | `dropy` | do.js:255 | Implemented |
| 807 | `dropz` | do.js:260 | Implemented |
| 849 | `engulfer_digests_food` | do.js:287 | Implemented |
...
| 2101 | `revive_corpse` | do.js:1623 | Implemented |
| 2241 | `revive_mon` | do.js:1656 | Implemented |
...
### dokick.c -> dokick.js, kick.js
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 412 | `container_impact_dmg` | dokick.js:889 | Implemented |
| 1854 | `deliver_obj_to_mon` | dokick.js:2109 | Implemented |
| 1257 | `dokick` | kick.js:handleKick | APPROX — kick command |
| 1943 | `down_gate` | dokick.js:2200 | Implemented |
| 1473 | `drop_to` | dokick.js:1778 | Implemented |
| 295 | `ghitm` | dokick.js:786 | Implemented |
| 1511 | `impact_drop` | dokick.js:1815 | Implemented |
| 910 | `kick_door` | dokick.js:1327 | Implemented |
| 864 | `kick_dumb` | dokick.js:1282 | Implemented |
| 146 | `kick_monster` | dokick.js:683 | Implemented |
| 974 | `kick_nondoor` | dokick.js:1392 | Implemented |
| 489 | `kick_object` | dokick.js:954 | Implemented |
| 881 | `kick_ouch` | dokick.js:1300 | Implemented |
| 794 | `kickstr` | dokick.js:1206 | Implemented |
| 126 | `maybe_kick_monster` | dokick.js:658 | Implemented |
| 1769 | `obj_delivery` | dokick.js:2019 | Implemented |
| 1909 | `otransit_msg` | dokick.js:2170 | Implemented |
| 508 | `really_kick_object` | dokick.js:972 | Implemented |
| 1639 | `ship_object` | dokick.js:1916 | Implemented |
| 846 | `watchman_door_damage` | dokick.js:1262 | Implemented |
| 834 | `watchman_thief_arrest` | dokick.js:1248 | Implemented |
...
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 120 | `def_char_is_furniture` | symbols.js:844 | Implemented |
| 108 | `def_char_to_monclass` | symbols.js:835 | Implemented |
| 91 | `def_char_to_objclass` | symbols.js:827 | Implemented |
...
| 2943 | `count_feat_lastseentyp` | dungeon.js:5631 | Implemented |
...
| 3286 | `dooverview` | dungeon.js:5741 | Implemented |
...
| 1548 | `earth_sense` | dungeon.js:5602 | Implemented |
...
| 2827 | `init_mapseen` | dungeon.js:5663 | Implemented |
| 463 | `insert_branch` | - | N/A — C linked list insertion, JS uses add_branch |
| 2872 | `interest_mapseen` | dungeon.js:5716 | Implemented |
...
| 2092 | `lev_by_name` | dungeon.js:5559 | Implemented |
| 2021 | `level_difficulty` | dungeon.js:5568 | Implemented |
...
| 2753 | `overview_stats` | dungeon.js:5731 | Implemented |
| 415 | `parent_dlevel` | dungeon.js:5528 | Implemented |
| 346 | `parent_dnum` | dungeon.js:5523 | Implemented |
| 632 | `pick_level` | dungeon.js:5547 | Implemented |
...
| 3508 | `print_mapseen` | dungeon.js:5723 | Implemented |
| 2494 | `query_annotation` | dungeon.js:5652 | Implemented |
| 3067 | `recalc_mapseen` | dungeon.js:5708 | Implemented |
| 2440 | `recbranch_mapseen` | dungeon.js:5703 | Implemented |
| 2803 | `remdun_mapseen` | dungeon.js:5694 | Implemented |
| 211 | `restore_dungeon` | - | N/A (save/restore, JS uses storage.js) |
| 2657 | `rm_mapseen` | dungeon.js:5685 | Implemented |
...
| 2687 | `save_mapseen` | dungeon.js:5671 | Implemented |
...
| 1599 | `u_on_rndspot` | dungeon.js:5580 | Implemented |
| 2169 | `unplaced_floater` | dungeon.js:5575 | Implemented |
| 2184 | `unreachable_level` | dungeon.js:5242 | Implemented |
| 2919 | `update_lastseentyp` | dungeon.js:5622 | Implemented |
| 2935 | `update_mapseen_for` | dungeon.js:5637 | Implemented |
...
| 832 | `odds_and_ends` | - | N/A — disabled in upstream C (`#if 0` legacy path) |
...
| 1038 | `datamodel` | hacklib.js:683 | Implemented |
...
| 918 | `nh_snprintf` | hacklib.js:737 | Implemented |
...
| 946 | `unicodeval_to_utf8str` | hacklib.js:766 | Implemented |
...
| 49 | `cursetxt` | mcastu.js:25 | Implemented |
...
| 375 | `touch_of_death` | mcastu.js:89 | Implemented |
...
| 584 | `mind_blast` | monmove.js | Partial — hero path applies real damage and reveals hidden/disguised hero before lock-on; monster-victim path keeps minimal wake semantics (`sleeping=false`) with RNG-faithful damage loop; remaining main gaps are exact C `losehp(\"psychic blast\")` killer-attribution path and tighter `wakeup()` parity semantics |
...
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 72 | `monst_globals_init` | monst.js:monst_globals_init | Implemented |

### mplayer.c -> mplayer.js
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 327 | `create_mplayers` | mplayer.js:130 | Implemented |
| 44 | `dev_name` | mplayer.js:dev_name | Implemented |
| 72 | `get_mplname` | mplayer.js:get_mplname | Implemented |
...
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 32 | `objects_globals_init` | objects.js:objects_globals_init | Implemented |
...
| 1119 | `dropp` | polyself.js:dropp | Implemented |
...
| 42 | `move_special` | priest.js:move_special | Implemented |
...
| 220 | `priestini` | priest.js:priestini | Implemented |
...
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 5812 | `Shk_Your` | shk.js:2385 | Implemented |
| 4334 | `add_damage` | shk.js:2198 | Implemented |
| 3250 | `add_one_tobill` | shk.js:619 | Implemented |
| 3306 | `add_to_billobjs` | shk.js:3214 | Implemented |
| 3430 | `addtobill` | shk.js:675 | Implemented |
| 437 | `addupbill` | shk.js:519 | Implemented |
| 4932 | `after_shk_move` | shk.js:2409 | Implemented |
| 3178 | `alter_cost` | shk.js:2720 | Implemented |
| 1272 | `angry_shk_exists` | shk.js:969 | Implemented |
| 3539 | `append_honorific` | shk.js:2325 | Implemented |
| 3327 | `bill_box_content` | shk.js:3225 | Implemented |
| 3391 | `billable` | shk.js:1093 | Implemented |
| 5726 | `block_door` | shk.js:2286 | Implemented |
| 5761 | `block_entry` | shk.js:2304 | Implemented |
| 2700 | `bp_to_obj` | shk.js:3130 | Implemented |
| 2250 | `buy_container` | shk.js:1981 | Implemented |
| 5843 | `cad` | shk.js:2904 | Implemented |
| 451 | `call_kops` | shk.js:2920 | Implemented |
| 1463 | `cheapest_item` | shk.js:3062 | Implemented |
| 1219 | `check_credit` | shk.js:540 | Implemented |
| 5674 | `check_unpaid` | shk.js:1348 | Implemented |
| 5623 | `check_unpaid_usage` | shk.js:1309 | Implemented |
| 377 | `clear_no_charge` | shk.js:788 | Implemented |
| 329 | `clear_no_charge_obj` | shk.js:774 | Implemented |
| 389 | `clear_no_charge_pets` | shk.js:2986 | Implemented |
| 319 | `clear_unpaid` | shk.js:766 | Implemented |
| 309 | `clear_unpaid_obj` | shk.js:759 | Implemented |
| 2936 | `contained_cost` | shk.js:2478 | Implemented |
| 2987 | `contained_gold` | shk.js:2499 | Implemented |
| 4210 | `corpsenm_price_adj` | shk.js:281 | Implemented |
| 5562 | `cost_per_charge` | shk.js:1279 | Implemented |
| 5304 | `costly_adjacent` | shk.js:1059 | Implemented |
| 5680 | `costly_gold` | shk.js:1215 | Implemented |
| 5285 | `costly_spot` | shk.js:1045 | Implemented |
| 569 | `credit_report` | shk.js:2578 | Implemented |
| 1116 | `delete_contents` | shk.js:2854 | Implemented |
| 664 | `deserted_shop` | shk.js:2864 | Implemented |
| 4465 | `discard_damage_owned_by` | shk.js:3359 | Implemented |
| 4444 | `discard_damage_struct` | shk.js:3352 | Implemented |
| 4132 | `doinvbill` | shk.js:2119 | Implemented |
| 3814 | `donate_gold` | shk.js:1247 | Implemented |
| 1684 | `dopay` | shk.js:1595 | Implemented |
| 2161 | `dopayobj` | shk.js:1948 | Implemented |
| 3005 | `dropped_container` | shk.js:2673 | Implemented |
| 4426 | `find_damage` | shk.js:3342 | Implemented |
| 1025 | `find_objowner` | shk.js:2750 | Implemented |
| 2718 | `find_oid` | shk.js:3142 | Implemented |
| 2664 | `finish_paybill` | shk.js:2569 | Implemented |
| 4785 | `fix_shop_damage` | shk.js:2790 | Implemented |
| 3139 | `gem_learned` | shk.js:2730 | Implemented |
| 2818 | `get_cost` | shk.js:328 | Implemented |
| 2750 | `get_cost_of_shop_item` | shk.js:2765 | Implemented |
| 2787 | `get_pricing_units` | shk.js:305 | Implemented |
| 5073 | `getcad` | shk.js:2255 | Implemented |
| 4254 | `getprice` | shk.js:3265 | Implemented |
| 5911 | `globby_bill_fixup` | shk.js:2828 | Implemented |
| 1258 | `home_shk` | shk.js:949 | Implemented |
| 1390 | `hot_pursuit` | shk.js:938 | Implemented |
| 2518 | `inherits` | shk.js:2510 | Implemented |
| 980 | `inhishop` | shk.js:838 | Implemented |
| 509 | `inside_shop` | shk.js:3006 | Implemented |
| 2396 | `insufficient_funds` | shk.js:1931 | Implemented |
| 4947 | `is_fshk` | shk.js:1126 | Implemented |
| 1108 | `is_unpaid` | shk.js:1115 | Implemented |
| 5541 | `kops_gone` | shk.js:2952 | Implemented |
| 4526 | `litter_getpos` | shk.js:3395 | Implemented |
| 4647 | `litter_newsyms` | shk.js:3387 | Implemented |
| 4557 | `litter_scatter` | shk.js:3411 | Implemented |
| 1411 | `make_angry_shk` | shk.js:921 | Implemented |
| 1336 | `make_happy_shk` | shk.js:895 | Implemented |
| 1381 | `make_happy_shoppers` | shk.js:914 | Implemented |
| 1486 | `make_itemized_bill` | shk.js:1833 | Implemented |
| 5048 | `makekops` | shk.js:3420 | Implemented |
| 1609 | `menu_pick_pay_items` | shk.js:1916 | Implemented |
| 5835 | `mon_owns` | shk.js:2361 | Implemented |
| 157 | `money2mon` | shk.js:577 | Implemented |
| 186 | `money2u` | shk.js:593 | Implemented |
| 215 | `next_shkp` | shk.js:502 | Implemented |
| 1067 | `noisy_shop` | shk.js:2696 | Implemented |
| 1128 | `obfree` | shk.js:3014 | Implemented |
| 2805 | `oid_price_adjustment` | shk.js:317 | Implemented |
| 1077 | `onbill` | shk.js:480 | Implemented |
| 1101 | `onshopbill` | shk.js:496 | Implemented |
| 1285 | `pacify_shk` | shk.js:870 | Implemented |
| 1238 | `pay` | shk.js:559 | Implemented |
| 1986 | `pay_billed_items` | shk.js:2035 | Implemented |
| 5109 | `pay_for_damage` | shk.js:2222 | Implemented |
| 2426 | `paybill` | shk.js:2553 | Implemented |
| 862 | `pick_pick` | shk.js:2642 | Implemented |
| 3026 | `picked_container` | shk.js:2662 | Implemented |
| 5341 | `price_quote` | shk.js:1379 | Implemented |
| 2360 | `reject_purchase` | shk.js:1924 | Implemented |
| 606 | `remote_burglary` | shk.js:2593 | Implemented |
| 4667 | `repair_damage` | shk.js:3328 | Implemented |
| 4387 | `repairable_damage` | shk.js:3303 | Implemented |
| 280 | `replshk` | shk.js:1013 | Implemented |
| 290 | `restshk` | shk.js:2994 | Implemented |
| 1303 | `rile_shk` | shk.js:852 | Implemented |
| 628 | `rob_shop` | shk.js:2173 | Implemented |
| 1322 | `rouse_shk` | shk.js:884 | Implemented |
| 896 | `same_price` | shk.js:2517 | Implemented |
| 5880 | `sasc_bug` | shk.js:2370 | Implemented |
| 3864 | `sellobj` | shk.js:2095 | Implemented |
| 3850 | `sellobj_state` | shk.js:2089 | Implemented |
| 3089 | `set_cost` | shk.js:439 | Implemented |
| 2623 | `set_repo_loc` | shk.js:3111 | Implemented |
| 272 | `set_residency` | shk.js:1023 | Implemented |
| 400 | `setpaid` | shk.js:796 | Implemented |
| 5456 | `shk_chat` | shk.js:1441 | Implemented |
| 5403 | `shk_embellish` | shk.js:1357 | Implemented |
| 4491 | `shk_fixes_damage` | shk.js:3370 | Implemented |
| 4376 | `shk_impaired` | shk.js:1037 | Implemented |
| 4815 | `shk_move` | shk.js:2418 | Implemented |
| 3353 | `shk_names_obj` | shk.js:1506 | Implemented |
| 5820 | `shk_owns` | shk.js:2349 | Implemented |
| 5797 | `shk_your` | shk.js:2376 | Implemented |
| 4297 | `shkcatch` | shk.js:2809 | Implemented |
| 235 | `shkgone` | shk.js:984 | Implemented |
| 931 | `shop_debt` | shk.js:530 | Implemented |
| 993 | `shop_keeper` | shk.js:144 | Implemented |
| 5321 | `shop_object` | shk.js:1070 | Implemented |
| 4954 | `shopdig` | shk.js:2262 | Implemented |
| 944 | `shopper_financial_report` | shk.js:2135 | Implemented |
| 1440 | `sortbill_cmp` | shk.js:3095 | Implemented |
| 3044 | `special_stock` | shk.js:2872 | Implemented |
| 3560 | `splitbill` | shk.js:700 | Implemented |
| 3650 | `stolen_container` | shk.js:3238 | Implemented |
| 3691 | `stolen_value` | shk.js:1135 | Implemented |
| 3598 | `sub_one_frombill` | shk.js:646 | Implemented |
| 3631 | `subfrombill` | shk.js:738 | Implemented |
| 1059 | `tended_shop` | shk.js:2690 | Implemented |
| 692 | `u_entered_shop` | shk.js:2608 | Implemented |
| 520 | `u_left_shop` | shk.js:2614 | Implemented |
| 3201 | `unpaid_cost` | shk.js:3193 | Implemented |
| 2112 | `update_bill` | shk.js:3071 | Implemented |
| 6036 | `use_unpaid_trapobj` | shk.js:3444 | Implemented |
...
| 360 | `init_shop_selection` | shknam.js:init_shop_selection | Implemented |
...
| 571 | `neweshk` | shknam.js:neweshk | Implemented |
...
| C Line | C Function | JS Line | Alignment |
|--------|------------|---------|-----------|
| 1779 | `activate_chosen_soundlib` | sounds.js:1304 | Implemented |
| 1556 | `add_sound_mapping` | sounds.js:1224 | Implemented |
| 1798 | `assign_soundlib` | sounds.js:1299 | Implemented |
| 2084 | `base_soundname_to_filename` | sounds.js:1258 | Implemented |
| 62 | `beehive_mon_sound` | sounds.js:103 | Implemented |
| 519 | `beg` | sounds.js:548 | Implemented |
| 1809 | `choose_soundlib` | sounds.js:1288 | Implemented |
| 617 | `cry_sound` | sounds.js:625 | Implemented |
| 1257 | `dochat` | sounds.js:1211 | Implemented |
| 679 | `domonnoise` | sounds.js:669 | Implemented |
| 202 | `dosounds` | sounds.js:227 | Implemented |
| 1248 | `dotalk` | sounds.js:1132 | Implemented |
| 1995 | `get_sound_effect_filename` | sounds.js:1265 | Implemented |
| 1864 | `get_soundlib_name` | sounds.js:1282 | Implemented |
| 402 | `growl` | sounds.js:446 | Implemented |
| 351 | `growl_sound` | sounds.js:407 | Implemented |
| 1981 | `initialize_semap_basenames` | sounds.js:1270 | Implemented |
| 546 | `maybe_gasp` | sounds.js:570 | Implemented |
| 1659 | `maybe_play_sound` | sounds.js:1247 | Implemented |
...
| 1927 | `nosound_achievement` | sounds.js:1327 | Implemented |
| 1947 | `nosound_ambience` | sounds.js:1330 | Implemented |
| 1922 | `nosound_exit_nhsound` | sounds.js:1312 | Implemented |
| 1937 | `nosound_hero_playnotes` | sounds.js:1318 | Implemented |
| 1917 | `nosound_init_nhsound` | sounds.js:1309 | Implemented |
| 1942 | `nosound_play_usersound` | sounds.js:1321 | Implemented |
| 1932 | `nosound_soundeffect` | sounds.js:1315 | Implemented |
| 1953 | `nosound_verbal` | sounds.js:1324 | Implemented |
| 181 | `oracle_sound` | sounds.js:200 | Implemented |
| 1642 | `play_sound_for_message` | sounds.js:1236 | Implemented |
| 1676 | `release_sound_mappings` | sounds.js:1231 | Implemented |
| 1413 | `responsive_mon_at` | sounds.js:1191 | Implemented |
| 2161 | `set_voice` | sounds.js:1208 | Implemented |
| 1629 | `sound_matches_message` | sounds.js:1216 | Implemented |
| 2185 | `sound_speak` | sounds.js:1213 | Implemented |
| 1883 | `soundlib_id_from_opt` | sounds.js:1275 | Implemented |
...
| 343 | `book_cursed` | spell.js:670 | Implemented |
...
| 189 | `confused_book` | spell.js:657 | Implemented |
...
| 356 | `learn` | spell.js:697 | Implemented |
...
| 687 | `rejectcasting` | spell.js:769 | Implemented |
...
| 1385 | `spelleffects` | spell.js:1083 | Partial — shared cast checks, energy accounting, forgotten-spell backfire, and dispatch scaffold implemented |
...
| 468 | `study_book` | spell.js:533 | Implemented |
...
| 120 | `thiefdead` | steal.js:102 | Implemented |
| 133 | `unresponsive` | steal.js:110 | Implemented — hero consciousness check |
| 147 | `unstolenarm` | steal.js:unstolenarm | Implemented |
| 165 | `stealarm` | steal.js:stealarm | Implemented |
...
| 689 | `stealamulet` | steal.js | Partial — invocation/amulet theft path implemented; quest-artifact targeting depends on `is_quest_artifact()` |
| 772 | `maybe_absorb_item` | steal.js:225 | Implemented |
| 814 | `mdrop_obj` | steal.js | Implemented |
| 852 | `mdrop_special_objs` | steal.js:234 | Implemented |
...
| 36 | `use_saddle` | steed.js:use_saddle | Implemented |
...
| 1894 | `control_mon_tele` | teleport.js:468 | Implemented |
...
| 48 | `goodpos_onscary` | teleport.js:154 | Implemented |
...
| 809 | `tele_to_rnd_pet` | teleport.js:1008 | Implemented |
...
| 1045 | `clear_bypass` | worn.js | Implemented |
| 1060 | `clear_bypasses` | worn.js | Implemented |
| 1109 | `bypass_obj` | worn.js | Implemented |
| 1117 | `bypass_objlist` | worn.js:776 | Implemented |
| 1132 | `nxt_unbypassed_obj` | worn.js | Implemented |
| 1149 | `nxt_unbypassed_loot` | worn.js | Implemented |
