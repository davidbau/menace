...
| `[a]` | artifact.c | artifact.js | Artifact system. 76 exports covering 70/74 C public functions (95%). Generated data table (artifacts.js) with artilist[], SPFX_*, ART_* constants. Existence tracking, pure predicates, combat (spec_applies/bane_applies/spec_abon/spec_dbon wired into uhitm/mhitm/mhitu), discovery, glow/Sting. Missing: get_artifact, glow_strength, hack_artifacts, untouchable |
