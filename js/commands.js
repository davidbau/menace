...
import { COLNO, ROWNO, STONE, DOOR, CORR, SDOOR, SCORR, STAIRS, LADDER, FOUNTAIN, SINK, THRONE, ALTAR, GRAVE,
         ...
         isok, A_STR, A_DEX, A_CON, A_WIS, STATUS_ROW_1, MAP_ROW_START,
...
import { handleEngrave, maybeSmudgeEngraving } from './engrave.js';
...
import { observeObject, handleDiscoveries, handleCallObjectTypePrompt } from './discovery.js';
...
// maybeSmudgeEngraving moved to engrave.js
...
// handleTogglePickup moved to pickup.js

// fetchDataFile, handleHelp, handleWhatis, handleWhatdoes, handleHistory,
// showGuidebook moved to pager.js

// handleSave moved to storage.js
// handleSet moved to options_menu.js

// isObjectTypeCallable, handleCallObjectTypePrompt moved to discovery.js
