...
import { u, get_nhlib_align } from '../sp_lev.js';
...
export async function generate() {
    ...
    await des.room({ type: "ordinary",lit: 1,x: 3,y: 3,
               ...
               contents: async function() {
                  await des.feature("fountain", 1,6);
                  await des.feature("fountain", 29,13);
      ...
      await des.room({ type: "temple",lit: 1,x: 10,y: 2,w: 3,h: 4,
                 contents: async function() {
                    ...
                    await des.altar({ x: 1, y: 1, align: align[0], type: "shrine" });
