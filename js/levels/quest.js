...
export function generate() {
    // NetHack quest.lua	$NHDT-Date: 1726894904 2024/9/21 5:1:44 $  $NHDT-Branch: NetHack-3.7 $:$NHDT-Revision: 1.10 $
    ...
    // Valid values for output are "pline", "text", && "menu, defaulting to
    // pline, unless the text contains newlines, || is too long to fit a message buffer,
    ...
    `,
          ...
          discourage: [
             ...
             "\"Let's see...args  Baked?  No.  Fried?  Nay.  Broiled?  Yea verily, that is the way I like my %c for dinner.\"",
    ...
    `,
          ...
          leader_other: {
             text: "\"Ah, you are here again, %p.  Allow me to determine your readiness...args\"",
          },
          locate_first: {
    ...
    *rustle* *rustle* (must be bats nearby.)
    ...
    `,
          ...
          encourage: [
             ...
             "\"Lazy S.O.B.  Maybe I should call up someone else...args\"",
    ...
    `,
          ...
          nemesis_first: {
             text: "\"Ah!  You must be %ls ...args er, `hero'.  A pleasure to meet you.\"",
          },
          nemesis_next: {
    ...
    `,
          ...
          discourage: [
             ...
             "\"Are you ready yet to beg for mercy?  I could be lenient...args\"",
    ...
    `,
          ...
          leader_next: {
             text: "\"Well, %p, you have returned.  Perhaps you are now ready...args\"",
          },
          leader_other: {
             text: `
