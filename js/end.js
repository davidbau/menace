...
import { hasGivenName, is_vampshifter } from './mondata.js';
...
async function maybeInstallPossessionsPrompt(how, game) {
    ...
    game.pendingPrompt = {
        ...
        onKey: async (chCode, gameCtx) => {
            ...
            if (ch !== 'y') {
                // C ref: ESC/n at possessions runs through all remaining
                // disclosures (all default to 'n') and finalizes immediately.
                gameCtx.pendingPrompt = null;
                clearEndPrompt(gameCtx.display);
                await installDisclosurePrompt(gameCtx, 0);
